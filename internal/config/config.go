...
// Config defines configuration options structure for SkyHigh API server.
type Config struct {
	...
	// Push represents the node structure
	Push Push `mapstructure:"node"`
...
// Push represents the Push node access configuration
type Push struct {
