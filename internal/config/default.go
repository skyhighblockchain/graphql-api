...
const (
	...
	defApplicationName = "SkyHigh GraphQL API Server (custom)"
	...
	// defPushUrl holds default Push connection string
	defPushUrl = "~/.skyhigh/data/skyhigh.ipc"
...
var defERC20Logo = map[common.Address]string{
	common.HexToAddress(EmptyAddress): "https://repository.skyhighblockchain.com/logos/erc20.svg",
}
...
func applyDefaults(cfg *viper.Viper) {
	...
	cfg.SetDefault(keyPushUrl, defPushUrl)
