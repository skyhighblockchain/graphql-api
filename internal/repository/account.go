...
// getAccount builds the account representation after validating it against Push node.
...
// AccountTransactions returns slice of AccountTransaction structure for a given account at SkyHigh blockchain.
