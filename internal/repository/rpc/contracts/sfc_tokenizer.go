...
var SfcTokenizerMetaData = &bind.MetaData{
	ABI: "[{\"constant\":false,\"inputs\":[{\"internalType\":\"address\",\"name\":\"addr\",\"type\":\"address\"}],\"name\":\"_updateSSKHTokenAddress\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[{\"internalType\":\"address\",\"name\":\"sender\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"stakerID\",\"type\":\"uint256\"}],\"name\":\"allowedToWithdrawStake\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"\",\"type\":\"bool\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[{\"internalType\":\"address\",\"name\":\"sender\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"stakerID\",\"type\":\"uint256\"}],\"name\":\"checkAllowedToWithdrawStake\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"stakerID\",\"type\":\"uint256\"},{\"internalType\":\"uint256\",\"name\":\"amount\",\"type\":\"uint256\"}],\"name\":\"redeemSSKH\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"name\":\"outstandingSSKH\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"sSKHTokenAddress\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[],\"name\":\"renounceOwnership\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[],\"name\":\"initialize\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"owner\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"isOwner\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"\",\"type\":\"bool\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"toStakerID\",\"type\":\"uint256\"}],\"name\":\"mintSSKH\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"internalType\":\"address\",\"name\":\"newOwner\",\"type\":\"address\"}],\"name\":\"transferOwnership\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"previousOwner\",\"type\":\"address\"},{\"indexed\":true,\"internalType\":\"address\",\"name\":\"newOwner\",\"type\":\"address\"}],\"name\":\"OwnershipTransferred\",\"type\":\"event\"}]",
}
...
// OutstandingSSKH is a free data retrieval call binding the contract method 0x5b04f4c8.
//
// Solidity: function outstandingSSKH(address , uint256 ) view returns(uint256)
func (_SfcTokenizer *SfcTokenizerCaller) OutstandingSSKH(opts *bind.CallOpts, arg0 common.Address, arg1 *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _SfcTokenizer.contract.Call(opts, &out, "outstandingSSKH", arg0, arg1)
...
//
// Solidity: function outstandingSSKH(address , uint256 ) view returns(uint256)
func (_SfcTokenizer *SfcTokenizerSession) OutstandingSSKH(arg0 common.Address, arg1 *big.Int) (*big.Int, error) {
	return _SfcTokenizer.Contract.OutstandingSSKH(&_SfcTokenizer.CallOpts, arg0, arg1)
}

// OutstandingSSKH is a free data retrieval call binding the contract method 0x5b04f4c8.
//
// Solidity: function outstandingSSKH(address , uint256 ) view returns(uint256)
func (_SfcTokenizer *SfcTokenizerCallerSession) OutstandingSSKH(arg0 common.Address, arg1 *big.Int) (*big.Int, error) {
	return _SfcTokenizer.Contract.OutstandingSSKH(&_SfcTokenizer.CallOpts, arg0, arg1)
}
...
// SSKHTokenAddress is a free data retrieval call binding the contract method 0x693c5e24.
//
// Solidity: function sSKHTokenAddress() view returns(address)
func (_SfcTokenizer *SfcTokenizerCaller) SSKHTokenAddress(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _SfcTokenizer.contract.Call(opts, &out, "sSKHTokenAddress")
...
//
// Solidity: function sSKHTokenAddress() view returns(address)
func (_SfcTokenizer *SfcTokenizerSession) SSKHTokenAddress() (common.Address, error) {
	return _SfcTokenizer.Contract.SSKHTokenAddress(&_SfcTokenizer.CallOpts)
}

// SSKHTokenAddress is a free data retrieval call binding the contract method 0x693c5e24.
//
// Solidity: function sSKHTokenAddress() view returns(address)
func (_SfcTokenizer *SfcTokenizerCallerSession) SSKHTokenAddress() (common.Address, error) {
	return _SfcTokenizer.Contract.SSKHTokenAddress(&_SfcTokenizer.CallOpts)
}

// UpdateSSKHTokenAddress is a paid mutator transaction binding the contract method 0x06f03e22.
//
// Solidity: function _updateSSKHTokenAddress(address addr) returns()
func (_SfcTokenizer *SfcTokenizerTransactor) UpdateSSKHTokenAddress(opts *bind.TransactOpts, addr common.Address) (*types.Transaction, error) {
	return _SfcTokenizer.contract.Transact(opts, "_updateSSKHTokenAddress", addr)
}

// UpdateSSKHTokenAddress is a paid mutator transaction binding the contract method 0x06f03e22.
//
// Solidity: function _updateSSKHTokenAddress(address addr) returns()
func (_SfcTokenizer *SfcTokenizerSession) UpdateSSKHTokenAddress(addr common.Address) (*types.Transaction, error) {
	return _SfcTokenizer.Contract.UpdateSSKHTokenAddress(&_SfcTokenizer.TransactOpts, addr)
}

// UpdateSSKHTokenAddress is a paid mutator transaction binding the contract method 0x06f03e22.
//
// Solidity: function _updateSSKHTokenAddress(address addr) returns()
func (_SfcTokenizer *SfcTokenizerTransactorSession) UpdateSSKHTokenAddress(addr common.Address) (*types.Transaction, error) {
	return _SfcTokenizer.Contract.UpdateSSKHTokenAddress(&_SfcTokenizer.TransactOpts, addr)
}
...
// MintSSKH is a paid mutator transaction binding the contract method 0xca2d6fd8.
//
// Solidity: function mintSSKH(uint256 toStakerID) returns()
func (_SfcTokenizer *SfcTokenizerTransactor) MintSSKH(opts *bind.TransactOpts, toStakerID *big.Int) (*types.Transaction, error) {
	return _SfcTokenizer.contract.Transact(opts, "mintSSKH", toStakerID)
}

// MintSSKH is a paid mutator transaction binding the contract method 0xca2d6fd8.
//
// Solidity: function mintSSKH(uint256 toStakerID) returns()
func (_SfcTokenizer *SfcTokenizerSession) MintSSKH(toStakerID *big.Int) (*types.Transaction, error) {
	return _SfcTokenizer.Contract.MintSSKH(&_SfcTokenizer.TransactOpts, toStakerID)
}

// MintSSKH is a paid mutator transaction binding the contract method 0xca2d6fd8.
//
// Solidity: function mintSSKH(uint256 toStakerID) returns()
func (_SfcTokenizer *SfcTokenizerTransactorSession) MintSSKH(toStakerID *big.Int) (*types.Transaction, error) {
	return _SfcTokenizer.Contract.MintSSKH(&_SfcTokenizer.TransactOpts, toStakerID)
}

// RedeemSSKH is a paid mutator transaction binding the contract method 0x4a37ec9d.
//
// Solidity: function redeemSSKH(uint256 stakerID, uint256 amount) returns()
func (_SfcTokenizer *SfcTokenizerTransactor) RedeemSSKH(opts *bind.TransactOpts, stakerID *big.Int, amount *big.Int) (*types.Transaction, error) {
	return _SfcTokenizer.contract.Transact(opts, "redeemSSKH", stakerID, amount)
}

// RedeemSSKH is a paid mutator transaction binding the contract method 0x4a37ec9d.
//
// Solidity: function redeemSSKH(uint256 stakerID, uint256 amount) returns()
func (_SfcTokenizer *SfcTokenizerSession) RedeemSSKH(stakerID *big.Int, amount *big.Int) (*types.Transaction, error) {
	return _SfcTokenizer.Contract.RedeemSSKH(&_SfcTokenizer.TransactOpts, stakerID, amount)
}

// RedeemSSKH is a paid mutator transaction binding the contract method 0x4a37ec9d.
//
// Solidity: function redeemSSKH(uint256 stakerID, uint256 amount) returns()
func (_SfcTokenizer *SfcTokenizerTransactorSession) RedeemSSKH(stakerID *big.Int, amount *big.Int) (*types.Transaction, error) {
	return _SfcTokenizer.Contract.RedeemSSKH(&_SfcTokenizer.TransactOpts, stakerID, amount)
}
