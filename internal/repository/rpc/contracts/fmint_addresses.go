...
// GetSkyHighMint is a free data retrieval call binding the contract method 0x44969711.
//
// Solidity: function getSkyHighMint() view returns(address)
func (_DefiFMintAddressProvider *DefiFMintAddressProviderCaller) GetSkyHighMint(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _DefiFMintAddressProvider.contract.Call(opts, &out, "getSkyHighMint")
...
//
// Solidity: function getSkyHighMint() view returns(address)
func (_DefiFMintAddressProvider *DefiFMintAddressProviderSession) GetSkyHighMint() (common.Address, error) {
	return _DefiFMintAddressProvider.Contract.GetSkyHighMint(&_DefiFMintAddressProvider.CallOpts)
}

// GetSkyHighMint is a free data retrieval call binding the contract method 0x44969711.
//
// Solidity: function getSkyHighMint() view returns(address)
func (_DefiFMintAddressProvider *DefiFMintAddressProviderCallerSession) GetSkyHighMint() (common.Address, error) {
	return _DefiFMintAddressProvider.Contract.GetSkyHighMint(&_DefiFMintAddressProvider.CallOpts)
}
...
// SetSkyHighMint is a paid mutator transaction binding the contract method 0xfcc3c074.
//
// Solidity: function setSkyHighMint(address _addr) returns()
func (_DefiFMintAddressProvider *DefiFMintAddressProviderTransactor) SetSkyHighMint(opts *bind.TransactOpts, _addr common.Address) (*types.Transaction, error) {
	return _DefiFMintAddressProvider.contract.Transact(opts, "setSkyHighMint", _addr)
}

// SetSkyHighMint is a paid mutator transaction binding the contract method 0xfcc3c074.
//
// Solidity: function setSkyHighMint(address _addr) returns()
func (_DefiFMintAddressProvider *DefiFMintAddressProviderSession) SetSkyHighMint(_addr common.Address) (*types.Transaction, error) {
	return _DefiFMintAddressProvider.Contract.SetSkyHighMint(&_DefiFMintAddressProvider.TransactOpts, _addr)
}

// SetSkyHighMint is a paid mutator transaction binding the contract method 0xfcc3c074.
//
// Solidity: function setSkyHighMint(address _addr) returns()
func (_DefiFMintAddressProvider *DefiFMintAddressProviderTransactorSession) SetSkyHighMint(_addr common.Address) (*types.Transaction, error) {
	return _DefiFMintAddressProvider.Contract.SetSkyHighMint(&_DefiFMintAddressProvider.TransactOpts, _addr)
}
