...
type ApiResolver interface {
	...
	// LastStakerId resolves the last staker id in SkyHigh blockchain.
	LastStakerId() (hexutil.Uint64, error)

	// StakersNum resolves the number of stakers in SkyHigh blockchain.
	...
	// Price resolves price details of the SkyHigh blockchain token for the given target symbols.
