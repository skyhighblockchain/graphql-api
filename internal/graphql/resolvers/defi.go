...
// defiWSKHSymbol is the symbol used for wrapped SKH tokens.
const defiWSKHSymbol = "WSKH"
...
// DefiNativeToken resolves the native SKH wrapper token.
...
// CanWrapSKH signals if the token can be used to wrap native SKH
// to get some amount of it.
func (dt *DefiToken) CanWrapSKH() bool {
	return dt.Symbol == defiWSKHSymbol
}
