...
const (
	// GasPricePeriodTypeSuggestion represents the type of gas price period data from the SkyHigh node suggestion call.
...
// estimation provided by the SkyHigh node.
